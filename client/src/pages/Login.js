...
//   phoneNumber: Yup.string().required("Required"), // Add phoneNumber validation
// });
...
//                   />
//                   <TextField
//                     label="Enter phone number" // Add phone number field
//                     name="phoneNumber"
...
const Login = () => {
  ...
  const getNewUserPriority = async () => {
    try {
      ...
      const usersCount = usersCountResponse.data.count; // Extract the count value from the response data
      return usersCount;
    } catch (error) {
  ...
  const handleRegister = async (values, onSubmitProps) => {
    try {
      ...
      if (newUserPriority !== null) {
        // Assign priority to the new user
